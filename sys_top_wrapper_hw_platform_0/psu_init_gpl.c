...
/*##################################################################### */
    ...
    * This register controls this reference clock
    * (OFFSET, MASK, VALUE)      (0XFF5E00C0, 0x013F3F07U ,0x01010803U)
    */
	PSU_Mask_Write(CRL_APB_PL0_REF_CTRL_OFFSET,
		0x013F3F07U, 0x01010803U);
/*##################################################################### */
    ...
    * ter 4 cycles of the old clock and 4 cycles of the new clock. This is not
    *  usually an issue, but designers must be aware.)
    *  PSU_CRL_APB_PL1_REF_CTRL_SRCSEL                             0x3

    * This register controls this reference clock
    * (OFFSET, MASK, VALUE)      (0XFF5E00C4, 0x013F3F07U ,0x01010203U)
    */
...
/*##################################################################### */
    ...
    * This register controls this reference clock
    * (OFFSET, MASK, VALUE)      (0XFF5E00C8, 0x013F3F07U ,0x01010502U)
    */
...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFD070020, 0x000003F3U ,0x00000202U)
    */
	PSU_Mask_Write(DDRC_DERATEEN_OFFSET, 0x000003F3U, 0x00000202U);
/*##################################################################### */
    ...
    *  PSU_DDRC_DERATEINT_MR4_READ_INTERVAL                        0x3d08d8

    * Temperature Derate Interval Register
    * (OFFSET, MASK, VALUE)      (0XFD070024, 0xFFFFFFFFU ,0x003D08D8U)
    */
	PSU_Mask_Write(DDRC_DERATEINT_OFFSET, 0xFFFFFFFFU, 0x003D08D8U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    *  PSU_DDRC_RFSHTMG_T_RFC_NOM_X32                              0x30
    ...
    */
	PSU_Mask_Write(DDRC_RFSHTMG_OFFSET, 0x0FFF83FFU, 0x00308070U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    *  PSU_DDRC_INIT0_PRE_CKE_X1024                                0x30f

    * SDRAM Initialization Register 0
    * (OFFSET, MASK, VALUE)      (0XFD0700D0, 0xC3FF0FFFU ,0x0002030FU)
    */
	PSU_Mask_Write(DDRC_INIT0_OFFSET, 0xC3FF0FFFU, 0x0002030FU);
/*##################################################################### */
    ...
    *  PSU_DDRC_INIT1_DRAM_RSTN_X1024                              0x50
    ...
    * (OFFSET, MASK, VALUE)      (0XFD0700D4, 0x01FF7F0FU ,0x00500000U)
    */
	PSU_Mask_Write(DDRC_INIT1_OFFSET, 0x01FF7F0FU, 0x00500000U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * 1024 clocks.
    *  PSU_DDRC_DRAMTMG0_T_RAS_MAX                                 0xd
    ...
    * (OFFSET, MASK, VALUE)      (0XFD070100, 0x7F3F7F3FU ,0x10100D11U)
    */
	PSU_Mask_Write(DDRC_DRAMTMG0_OFFSET, 0x7F3F7F3FU, 0x10100D11U);
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFD070104, 0x001F1F7FU ,0x0003041AU)
    */
	PSU_Mask_Write(DDRC_DRAMTMG1_OFFSET, 0x001F1F7FU, 0x0003041AU);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFD07010C, 0x3FF3F3FFU ,0x00C06000U)
    */
	PSU_Mask_Write(DDRC_DRAMTMG3_OFFSET, 0x3FF3F3FFU, 0x00C06000U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    *  PSU_DDRC_DRAMTMG5_T_CKE                                     0x6

    * SDRAM Timing Register 5
    * (OFFSET, MASK, VALUE)      (0XFD070114, 0x0F0F3F1FU ,0x01030606U)
    */
	PSU_Mask_Write(DDRC_DRAMTMG5_OFFSET, 0x0F0F3F1FU, 0x01030606U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFD07011C, 0x00000F0FU ,0x00000301U)
    */
	PSU_Mask_Write(DDRC_DRAMTMG7_OFFSET, 0x00000F0FU, 0x00000301U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    *  PSU_DDRC_ZQCTL0_T_ZQ_LONG_NOP                               0x190
    ...
    * DDR3/LPDDR4 devices.
    *  PSU_DDRC_ZQCTL0_T_ZQ_SHORT_NOP                              0xc

    * ZQ Control Register 0
    * (OFFSET, MASK, VALUE)      (0XFD070180, 0xF7FF03FFU ,0x8190000CU)
    */
	PSU_Mask_Write(DDRC_ZQCTL0_OFFSET, 0xF7FF03FFU, 0x8190000CU);
/*##################################################################### */
    ...
    *  PSU_DDRC_ZQCTL1_T_ZQ_RESET_NOP                              0x14
    ...
    * /LPDDR4 devices.
    *  PSU_DDRC_ZQCTL1_T_ZQ_SHORT_INTERVAL_X1024                   0x4c4b0

    * ZQ Control Register 1
    * (OFFSET, MASK, VALUE)      (0XFD070184, 0x3FFFFFFFU ,0x0144C4B0U)
    */
	PSU_Mask_Write(DDRC_ZQCTL1_OFFSET, 0x3FFFFFFFU, 0x0144C4B0U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * Refresh Period
    *  PSU_DDR_PHY_PGCR2_TREFPRD                                   0x5db0

    * PHY General Configuration Register 2
    * (OFFSET, MASK, VALUE)      (0XFD080018, 0xFFFFFFFFU ,0x00F05DB0U)
    */
	PSU_Mask_Write(DDR_PHY_PGCR2_OFFSET, 0xFFFFFFFFU, 0x00F05DB0U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    *  PSU_DDR_PHY_DTPR1_TMRD                                      0xd

    * DRAM Timing Parameters Register 1
    * (OFFSET, MASK, VALUE)      (0XFD080114, 0xFFFFFFFFU ,0x2820070DU)
    */
	PSU_Mask_Write(DDR_PHY_DTPR1_OFFSET, 0xFFFFFFFFU, 0x2820070DU);
/*##################################################################### */
    ...
    */
	PSU_Mask_Write(DDR_PHY_DTPR2_OFFSET, 0xFFFFFFFFU, 0x000F00E6U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    */
	PSU_Mask_Write(DDR_PHY_DTPR4_OFFSET, 0xFFFFFFFFU, 0x00E02B09U);
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFD080124, 0xFFFFFFFFU ,0x00331A08U)
    */
	PSU_Mask_Write(DDR_PHY_DTPR5_OFFSET, 0xFFFFFFFFU, 0x00331A08U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFD080680, 0xFFFFFFFFU ,0x0089EC58U)
    */
	PSU_Mask_Write(DDR_PHY_ZQCR_OFFSET, 0xFFFFFFFFU, 0x0089EC58U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    * DAXT8 0-1 PLL Control Register 0
    * (OFFSET, MASK, VALUE)      (0XFD081484, 0xFFFFFFFFU ,0x22120000U)
    */
...
/*##################################################################### */
    ...
    * DAXT8 0-1 PLL Control Register 0
    * (OFFSET, MASK, VALUE)      (0XFD0814C4, 0xFFFFFFFFU ,0x22120000U)
    */
...
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFF180204, 0x003FDFBFU ,0x00240000U)
    */
	PSU_Mask_Write(IOU_SLCR_MIO_MST_TRI0_OFFSET,
		0x003FDFBFU, 0x00240000U);
/*##################################################################### */
    ...
    * (OFFSET, MASK, VALUE)      (0XFF180208, 0x000FE000U ,0x00002000U)
    */
	PSU_Mask_Write(IOU_SLCR_MIO_MST_TRI1_OFFSET,
		0x000FE000U, 0x00002000U);
/*##################################################################### */
...
/*##################################################################### */
    ...
    *  AXI data width (default) 01: 64-bit AXI data width 10: 128-bit AXI data
    *  width 11: reserved
    *  PSU_FPD_SLCR_AFI_FS_DW_SS1_SEL                              0x1

    * afi fs SLCR control register. This register is static and should not be
    * modified during operation.
    * (OFFSET, MASK, VALUE)      (0XFD615000, 0x00000F00U ,0x00000500U)
    */
	PSU_Mask_Write(FPD_SLCR_AFI_FS_OFFSET, 0x00000F00U, 0x00000500U);
/*##################################################################### */
    ...
    */
	PSU_Mask_Write(AFIFM2_AFIFM_RDCTRL_OFFSET, 0x00000003U, 0x00000001U);
/*##################################################################### */
    ...
    */
	PSU_Mask_Write(AFIFM3_AFIFM_RDCTRL_OFFSET, 0x00000003U, 0x00000001U);
/*##################################################################### */
    ...
    */
	PSU_Mask_Write(AFIFM2_AFIFM_WRCTRL_OFFSET, 0x00000003U, 0x00000001U);
/*##################################################################### */
    ...
    */
	PSU_Mask_Write(AFIFM3_AFIFM_WRCTRL_OFFSET, 0x00000003U, 0x00000001U);
/*##################################################################### */
...
unsigned long psu_ddr_phybringup_data(void)
{
	...
	Xil_Out32(0xFD080068, 0x02120000); /* PLLCR0*/
	Xil_Out32(0xFD081404, 0x02120000); /* DX8SL0PLLCR0*/
	Xil_Out32(0xFD081444, 0x02120000); /* DX8SL1PLLCR0*/
	Xil_Out32(0xFD081484, 0x02120000); /* DX8SL2PLLCR0*/
	Xil_Out32(0xFD0814C4, 0x02120000); /* DX8SL3PLLCR0*/
	Xil_Out32(0xFD081504, 0x02120000); /* DX8SL4PLLCR0*/
	Xil_Out32(0xFD0817C4, 0x02120000); /* DX8SLBPLLCR0*/
	int cur_fbdiv;
	...
	Xil_Out32(0xFD080068, cur_PLLCR0); /*PLLCR0*/
	Xil_Out32(0xFD081404, cur_DX8SL0PLLCR0); /*DX8SL0PLLCR0*/
	Xil_Out32(0xFD081444, cur_DX8SL1PLLCR0); /*DX8SL1PLLCR0*/
	Xil_Out32(0xFD081484, cur_DX8SL2PLLCR0); /*DX8SL2PLLCR0*/
	Xil_Out32(0xFD0814C4, cur_DX8SL3PLLCR0); /*DX8SL3PLLCR0*/
	Xil_Out32(0xFD081504, cur_DX8SL4PLLCR0); /*DX8SL4PLLCR0*/
	Xil_Out32(0xFD0817C4, cur_DX8SLBPLLCR0); /*DX8SLBPLLCR0*/
	for (int tp = 0; tp < 20; tp++)
		regval = Xil_In32(0xFD070018);

dpll_prog(cur_fbdiv, DPLL_CFG_LOCK_DLY, DPLL_CFG_LOCK_CNT,
	DPLL_CFG_LFHF, DPLL_CFG_CP, DPLL_CFG_RES);
...
/*Vref training is complete, disabling static read mode*/
	...
	Xil_Out32(0xFD070180U, 0x0190000CU);
	Xil_Out32(0xFD070060U, 0x00000000U);
	prog_reg(0xFD080014U, 0x00000040U, 0x00000006U, 0x00000000U);
	for (int tp = 0; tp < 4000; tp++)
		regval = Xil_In32(0xFD070018);

	prog_reg(0xFD080090U, 0x00000FC0U, 0x00000006U, 0x00000005U);
